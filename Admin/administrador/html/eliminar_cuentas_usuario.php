        ...
        <div class="row">
            <div class="col-lg-9">
                <table class = "table table-striped table-hover">
                    <tr>
                        <td>
                             <input type="text" name="busqueda" id="busqueda"  placeholder="Codigo_Cuenta" autocomplete=”on”  class="form-control">
                        </td>
                        <td>
        ...
        <div class="row">
            ...
            <div class="col-lg-12"> 
                <table class = "table table-striped table-hover">    
                            ...
                            <tr>
                                <td colspan="2">
                                     <button name="btn-actualizar" id="btn-actualizar" class="btn btn-primary">Eliminar</button>
                                    <button name="btn-cancelar" id="btn-cancelar" class="btn btn-warning">Cancelar</button>
                                </td>
                            </tr>
                </table>
            </div>
