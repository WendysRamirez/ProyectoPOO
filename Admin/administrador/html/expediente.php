            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                           ...
                           <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <button name="btn-guardar" id="btn-guardar" class="btn btn-primary">Guardar</button> <button name="btn-modificar" id="btn-modificar" class="btn btn-primary">Modificar</button>
                                </td>
                            </tr>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="table table-striped table-hover">
                            <tr>Historial de citas</tr>
                                <tr>
                                <td>Sintomas:</td>
                                <td>
                                <input type=" text" name="sintomas" id="txt-sintomas" class="form-control" >
                                <p class="help-block">Sintomas</p>
                                
                                </td>
                                </tr>
                          
                                <tr>
                                <td>Medicamento Aplicado: </td>
                                <td>
                                    <input type="text" name="Medicamento" id="txt-medicamento" class="form-control" placeholder="Medicamento Aplicado">
                                
                                </td>
                                </tr>
                                <tr>
                                <td>Tratamiento Recibido: </td>
                                <td>
                                     <input type="text" name="tratamiento-recibido" id="txt-tratamiento-recibido" class="form-control" placeholder="tratamiento-recibido"> 
                                </td>
                                </tr>
